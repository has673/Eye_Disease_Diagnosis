...
export default function Check() {
  ...
  //   try {
  //     const modelJSON = require('../mod/model.json');
  //     const modelWeightsURI = 'D:\Fyp\Eye_Disease_Diagnosis\Screen\mod\weights.bin';
  
  //     const response = await fetch(modelWeightsURI);
  ...
  //     setPred(predictions);
  //     navigation.navigate('Tumor_Report', predictions);
  //   } else {
